...
const Contact = () => {
	...
	const contactInfo = [
		{
			...
			label: 'Email',
			value: 'fahimiyassir4@gmail.com',
			link: 'mailto:fahimiyassir4@gmail.com'
		},
		{
			icon: <Phone className="w-5 h-5" />,
			label: 'Téléphone',
			value: '+212 625343237',
			link: 'tel:+212625343237'
		},
		{
	...
	const socialLinks = [
		...
		},
		{
			...
			label: 'LinkedIn',
			link: 'https://linkedin.com/in/yassir-fahimi-265826218'
		},
		{
			icon: <MessageCircle className="w-5 h-5" />,
			label: 'WhatsApp',
			link: 'https://wa.me/+212625343237'
		}
	];
				...
				<div className="grid lg:grid-cols-[1fr,1.5fr] gap-8 sm:gap-12">
					...
					<div className="space-y-6 sm:space-y-8">
						...
						<motion.div
							...
							className="bg-gray-800/50 p-5 sm:p-6 rounded-xl backdrop-blur-sm"
						>
							<h3 className="text-lg sm:text-xl font-semibold mb-4">Horaires</h3>
							<div className="space-y-2 text-gray-400 text-sm sm:text-base">
								<p>Lundi - Vendredi : 9h00 - 18h00 (CET)</p>
								<p>Samedi : 10h00 - 14h00 (CET)</p>
								<p>Dimanche : Fermé</p>
							</div>
						</motion.div>
					</div>
