	...
	const educationData = [
		{
			...
			degree: "Diplôme d'Ingénieur d'État (Data & Software Engineering)",
			...
			coursework: [
				...
				"Architectures Backend & DevOps",
				"Bases de données & Machine Learning",
			],
			description: "Ingénieur diplômé de l'INSEA en Data & Software Engineering, avec une formation scientifique solide issue des classes préparatoires MP. Spécialisé dans la conception d'applications de bout en bout combinant développement full-stack, ingénierie logicielle, systèmes orientés data et intégration d'IA (agents intelligents, RAG)."
		},
		{
