...
const Home = () => {
  ...
  const email = "fahimiyassir4@gmail.com";
  const whatsappNumber = "+212625343237";

  const { data: githubData, error } = useSWR(
    "https://api.github.com/users/yassir1410",
    fetcher,
    {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 mt-7 sm:mt-0 md:mt-3 lg:mt-5">
      <div className="text-center relative z-10 max-w-4xl mx-auto">
        ...
        >
          Étudiant ingénieur à l’INSEA, spécialisé en conception et développement de solutions logicielles et en ingénierie des données.
        </motion.p>
        ...
        >
          <div className="flex justify-center space-x-3 sm:space-x-4">
            <Link
              href="/files/cv_pdf/cv_yassir_fahimi.pdf"
              target="_blank"
        ...
        >
          <motion.a
            href="https://github.com/yassir-fahimi"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <motion.a
            href="https://linkedin.com/in/yassir-fahimi-265826218"
            target="_blank"
            rel="noopener noreferrer"
            className="flex flex-col items-center group w-full"
            whileHover={{ y: -2 }}
